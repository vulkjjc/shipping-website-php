...
if(isset($_POST['submit']))
{
   ...
   // $password = password_hash($password, PASSWORD_DEFAULT);  
        $insert_Query = "INSERT INTO `sender`(`Email`,`FirstName`,`LastName`,`Address`) 
		VALUES ('$Email', '$Firstname','$Lastname','$Address')";
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="active"><a href="sender.php"><span class="glyphicon glyphicon-export"></span>SENDER</a></li>
...
<div class="sender">
  ...
  <div class="row">
    <div class="col-sm-6">
      ...
      <input class="form-control" id="name" name="firstname" maxlength="20" placeholder="Enter First Name" type="text" required>
      <p color="#333"><b>Last Name</b></p>
      <input class="form-control" id="name" name="lastname" maxlength="30" placeholder="Enter Last Name" type="text" required>
    </div>
    <div class="col-sm-6">
	  <p color="#333"><b>Address</b></p>
      <input class="form-control" id="name" name="address" maxlength="40" placeholder="Enter Address" type="text" required>
	   <p color="#333"><b>Email</b></p>
      <input class="form-control" id="name" name="email" maxlength="50" placeholder="Enter Email" type="email" required>
